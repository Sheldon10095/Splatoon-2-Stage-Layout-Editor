...
namespace SampleMapEditor.LayoutEditor
{
    public class MapObjectUI
    {
        ...
        /*private string[] DisplayWarnings(MuElement mapObject)
        {
        ...
        /*private void LoadParameterUI(MuElement mapObject)
        {
        ...
        /*private void LoadPathUI(MuElement mapObject)
        {
        ...
        /*private void DisplayPointLinkUI(string text, MuElement mapObject, string properyName, object path)
        {
        ...
        /*private void DisplayLapPointLinkUI(string text, MuElement mapObject, string properyName, object path)
        {
            EventHandler onLink = (sender, e) => {
                mapObject.NotifyPropertyChanged(properyName);
            };
        ...
        /*private void DisplayGroupLinkUI<TPath, TPoint>(string text, MuElement mapObject, string properyName)
